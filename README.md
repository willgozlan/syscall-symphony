...
2.) Verify dependencies:  
  ...
  - Right now, many assumptions are made that the repo is cloned into the home directory, and that the user is the `pi` user. However, as mentioned in the report, we will fix that before the project is finalized. For now, please be the pi user, and if not, I'll have specific modification instructions here. 
